...
public class sanctuaryDriverClass {
  public static void main(String[] args) {
    JungleSanctuary primateSanctuary = new Animal();

    // Assuming there are 11 incoming monkeys
    primateSanctuary.addNewMonkey("Paula", Species.HOWLER, 10, 20, FavoriteFood.EGGS, Sex.FEMALE,5);
    primateSanctuary.addNewMonkey("Zen", Species.HOWLER, 7, 20, FavoriteFood.NUTS, Sex.FEMALE,5);
    primateSanctuary.addNewMonkey("Alice",Species.HOWLER,8,34,FavoriteFood.FRUITS,Sex.MALE,11);
    primateSanctuary.addNewMonkey("Clara", Species.HOWLER, 18, 10, FavoriteFood.TREESAP, Sex.FEMALE,30);
    ...
    primateSanctuary.addNewMonkey("Jared",Species.MANGABEU,7,13,FavoriteFood.NUTS,Sex.MALE,12);
    primateSanctuary.addNewMonkey("Olive", Species.GUEREZA, 15, 60, FavoriteFood.SEEDS, Sex.FEMALE, 25);
    primateSanctuary.addNewMonkey("Cal",Species.DRILL,8,14,FavoriteFood.FRUITS,Sex.MALE,4.5);
    ...
    System.out.println("\n **************** Species housed in Sanctuary are stated below  ****************************** \n" + monkeyList);
    ...
    System.out.println("\n **************** Looking up for monkeys belonging to " + Species.HOWLER + " type *****************************  \n" + lookUpSpeciesResult);
